...
static const struct ili9881c_instr dlc350_init[] = {
...
static int ili9881c_prepare(struct drm_panel *panel)
{
  ...
  // send init commands to panel  
	...
	if (ret < 0) {
		dev_err(&ctx->dsi->dev, "Read register 0x0C failed\n");
		// return -ENODEV;
	} else {
...
static const struct drm_display_mode dlc350_default_mode = {
	.clock		= 48308, 
...
static const struct ili9881c_desc dlc350_desc = {
	.init = dlc350_init,
	.init_length = ARRAY_SIZE(dlc350_init),
	.mode = &dlc350_default_mode,
	.flags = MIPI_DSI_MODE_VIDEO_SYNC_PULSE | MIPI_DSI_MODE_VIDEO,
};
